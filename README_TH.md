...
<p align="center">
  <strong>คอนโซลเว็บสำหรับเก็บรักษาเรื่องราวครอบครัวข้ามรุ่น · การบันทึกเสียงผู้สูงอายุ + การโต้ตอบกับครอบครัว + การค้นหาเชิงความหมาย</strong>
</p>
...
> **ทำไมไม่ใช้แอปอัลบั้มรูปครอบครัวที่มีอยู่แล้ว?** เพราะแอปเหล่านั้นถูกสร้างมาสำหรับรูปภาพ ไม่ใช่ไฟล์เสียงระยะยาว พวกมันไม่มีการเน้นข้อความ-เสียง, การค้นหาเชิงความหมาย, การควบคุมสิทธิ์สมาชิกครอบครัวตาม RLS, หรือวงจรโต้ตอบ "ครอบครัวถาม → ผู้สูงอายุบันทึก → ครอบครัวแสดงความคิดเห็น" TimeLog ถูกสร้างมาเพื่อเติมช่องว่างนี้
...
**การเปิดเผยช่องโหว่**: อีเมล **`timelog-security [at] googlegroups [dot] com`** — อย่าเปิด Issue สาธารณะ เรามุ่งมั่นตอบสนองภายใน 24 ชั่วโมงแรก
