# Contributing to TimeLog Web

We love your input! We want to make contributing to TimeLog Web as easy and transparent as possible, whether it's:
...
2. Clone your fork: `git clone https://github.com/yourusername/timelog-web.git`
3. Install dependencies: `pnpm install`
4. Set up environment variables (see README.md)
5. Configure Supabase connection if applicable
...
5. Build the project to ensure it compiles: `pnpm build`
